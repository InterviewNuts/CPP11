...
int main()
{
    ...
    std::future<string> resFromDB= std::async(std::launch::deferred,fetchDataFromDBFunctor()," Data From DB");
    ...
    std::cout << "Total Time Taken ( Function Object) = " << diff << " Seconds" << std::endl;
