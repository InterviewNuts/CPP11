...
int get_unique_number_from_array(int arr[],int sz)
{
...
void  get_first_unique_number_from_array(int arr[],int sz,int res)
{
...
int main()
{
    ...
    int res=get_unique_number_from_array(arr,sizeof(arr)/sizeof(arr[0]));
    ...
    //! 2^3^2, 2 will be canceled out and 3 remains, which is the second ans.
    get_first_unique_number_from_array(arr,sizeof(arr)/sizeof(arr[0]), res);
